...
import org.tr.edu.yildiz.ce.openareas.utils.MatlabSession;
...
public class YTUDavutpasaIktisadiIdariBilimlerFakultesi {
	...
	public static void main(String[] args) throws Exception {
		...
		MatlabSession matlab = new MatlabSession("/home/puya/Documents/FinalProject/Output/", false);
		matlab.define("INT", 1);
		matlab.define("FLOAT", 1.6f);
		matlab.define("DOUBLE", 1.090992008816840058856677899017394776539477599467725353817);
		matlab.define("LIST", outputs.get(1.0));
		int[] array = {5, 6, 7};
		matlab.define("ARRAY", array);
		matlab.define("MAP", outputs);
		matlab.histogram(outputs.get(1.0));
